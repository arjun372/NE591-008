...
\page outlab6 OutLab 06: Iterative Linear Equation Solvers
</div>

# OutLab 06: Iterative Linear Equation Solvers
...
```shell
NE591: OutLab 06: Solving a system of linear equations using iterative methods
Arjun Earthperson
10/06/2023
--------------------------------------------------------------------------------
