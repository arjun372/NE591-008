  ...
  protected:
    ...
    void buildInputArguments(
        ...
        values.add_options()("threshold,t",
            ...
            "= maximum number of iterations [n ∈ ℕ]")(
        ...
        methods.add_options()("use-point-jacobi",
     ...
     */
    void buildInputs(InLab6Inputs &inputs,
        ...
        inputs.coefficients = MyBLAS::Matrix(
            std::vector<std::vector<long double>>(inputMap["coefficients"]));
        ...
        if (!values.count("order")) {
            ...
            if (orderFromUser > orderFromInputMatrixDimensions) {
                std::cerr << "Warning: Matrix order (n) is larger than input "
                             "matrix, defaulting to lower value\n";
            }
        }
