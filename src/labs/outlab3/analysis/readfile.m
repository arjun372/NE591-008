...
scatter(points, error, 'LineWidth', 2);

legend('Trapezoidal Rule', "Simpson's Rule", 'Gauss-Legendre Quadrature', 'Interpreter','latex', 'Location', 'northeast');
...
plot(points, runtime, '--');
set(gca,'ColorOrderIndex',1)
scatter(points, runtime, 'LineWidth', 2);

legend('Trapezoidal Rule', "Simpson's Rule", 'Gauss-Legendre Quadrature', 'Interpreter','latex', 'Location', 'northwest');
