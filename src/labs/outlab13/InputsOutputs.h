 ...
 * @date 10/13/2023
 * @brief This file contains the input and output definitions for this lab.
 */

#ifndef NE591_008_OUTLAB13_INPUTOUTPUTS_H
#define NE591_008_OUTLAB13_INPUTOUTPUTS_H
...
typedef struct Input {
    ...
    MyBLAS::NumericType L;
    MyBLAS::NumericType rho;
    MyBLAS::NumericType beta;
    size_t n;
...
#endif // NE591_008_OUTLAB13_INPUTOUTPUTS_H
