 ...
 *
 * Function to perform forward substitution, which is used in solving a system
 * of linear equations after the system matrix has been decomposed into a lower
 ...
 */
template <typename T>
MyBLAS::Vector<T> doForwardSubstitution(const MyBLAS::Matrix<T> &L,
 ...
 *
 * Function to perform backward substitution, which is used in solving a system
 * of linear equations after the system matrix has been decomposed into a lower
 * triangular matrix and an upper triangular matrix, and forward substitution
 * has been performed.
 *
 * @tparam T Using templates for data type consistency in computation.
 ...
 */
template <typename T>
MyBLAS::Vector<T> doBackwardSubstitution(const MyBLAS::Matrix<T> &U,
