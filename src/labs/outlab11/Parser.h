...
#ifndef NE591_008_OUTLAB11_PARSER_H
#define NE591_008_OUTLAB11_PARSER_H
 ...
 *
 * The Parser class extends the CommandLine class template with OutLab11Inputs as the template argument.
 ...
 */
class Parser : public CommandLine<OutLab11Inputs> {
  ...
  public:
     ...
     */
    explicit Parser(const HeaderInfo &headerInfo, const CommandLineArgs &args) : CommandLine<OutLab11Inputs>(headerInfo, args) {}
  ...
  protected:
     ...
     */
    void buildInputs(OutLab11Inputs &input, boost::program_options::variables_map &values) override {
...
#endif // NE591_008_OUTLAB11_PARSER_H
