 ...
 *
 * The Parser class extends the CommandLine class template with InLab11Inputs as the template argument.
 ...
 */
class Parser : public CommandLine<InLab11Inputs> {
  ...
  public:
     ...
     */
    explicit Parser(const HeaderInfo &headerInfo, const CommandLineArgs &args) : CommandLine<InLab11Inputs>(headerInfo, args) {}
  ...
  protected:
     ...
     */
    void buildInputs(InLab11Inputs &input, boost::program_options::variables_map &values) override {
