...
namespace MyBLAS {
    ...
    */
     ...
     */
    template<typename T>
    inline bool isSquareMatrix(const MyBLAS::Matrix<T> &M) {
     ...
     */
    template<typename T>
    bool isBinaryMatrix(const MyBLAS::Matrix<T> &M) {
     ...
     */
    template<typename T>
    bool isUpperTriangularMatrix(const MyBLAS::Matrix<T> &U) {
     ...
     */
    template<typename T>
    bool isPermutationMatrix(const MyBLAS::Matrix<T> &P) {
     ...
     */
    template<typename T>
    bool isDiagonallyDominant(const MyBLAS::Matrix<T> &A) {
