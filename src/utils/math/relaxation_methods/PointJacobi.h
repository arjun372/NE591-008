...
namespace MyRelaxationMethod {
     ...
     * @param tolerance The tolerance for convergence. The method stops if the L2 norm of the difference between two successive solutions is less than this value.
