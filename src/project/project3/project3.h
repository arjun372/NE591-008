 ...
 * @date 10/13/2023
 * @brief This file contains the declaration for the Project3 class.
 *
 */

#ifndef NE591_008_PROJECT3_PROJECT3_H
#define NE591_008_PROJECT3_PROJECT3_H
 ...
 */
class Project3 : public Project<SolverInputs, Parser, SolverOutputs> {

  public:
    /**
     * @brief Constructor for the project3 class
     * @param args Command line arguments
     */
    explicit Project3(CommandLineArgs args) : Project(args) {
...
#endif // NE591_008_PROJECT3_PROJECT3_H
