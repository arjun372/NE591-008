...
export INPUT_PARAMETERS=./src/project/project4/examples/config_32x32.json
export INPUT_SOURCETERMS=./src/project/project4/examples/sources_32x32.csv

export OUTPUT_RESULTS=./src/project/project4/examples/results_32x32.json
export OUTPUT_COMPUTED_FLUX=./src/project/project4/examples/results_32x32
...
```shell
NE591: Project Milestone 4: Performance Evaluation of Parallel vs Serial Point Jacobi Solvers
Arjun Earthperson
10/20/2023
--------------------------------------------------------------------------------
...
--------------------------------------------------------------------------------
	...
	Output JSON,    o: ../project4_16x16.json
	----
...
--------------------------------------------------------------------------------
	...
	absolute maximum residual : nan
--------------------------------------------------------------------------------
JSON data has been written to ../project4_16x16.json
